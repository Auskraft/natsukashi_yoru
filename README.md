...
- **14 игр** в одном приложении — от Snake до Warehouse.
...
| Lines | ライン | уровни · рекорд |
| Match3 | マッチ3 | блиц 60 сек · рекорд |
| Gems | ジュエル | 25 ходов · спец-камни |
| Drops | ドロップ | цепочки · рекорд |
| Minesweeper | 地雷 | на время (лучшее = быстрее) |
| 2048 | 数字 | свайп-слияния · рекорд |
| Blocks | ブロック | drag-полимино · рекорд |
...
| Bricks | レンガ | жизни + уровни · рекорд |
| Warehouse | 倉庫 | 6 уровней (меньше ходов) |
