...
- 🎮 **Настраиваемое управление** (готово; см. память `control-scheme-feature`): схема
  по каждой игре (жесты/крестовина/сплит/джойстик/поворот/наклон/тетрис-кнопки/ракетка)
  + пикер с превью. Вход — «🎮 Управление» внизу лобби или иконка на карточке игры.
  Раскатано на Snake, 2048, Warehouse, Lines, Drops, Bricks.
